...
3) The mean is  and the standard distribution is  . Since both are finite, it satisfies conditions 1 and 2. However, this is not a normal distribution, so a sample size of sufficiently large size (genrally 30 or greater) is required to meet this condition.
